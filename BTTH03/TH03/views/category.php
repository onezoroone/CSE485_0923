            ...
            <div class="position-sticky sidebar-wrapper">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item sidebar-element">
                        <a class="nav-link" href=".?c=music&a=index"><i class="bi bi-file-music"></i><span class="fs-5 p-3 hide-when-collapsed">Bài hát</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="#" type="submit" class="nav-link"><i class="bi bi-tags-fill"></i><span class="fs-5 p-2 hide-when-collapsed">Thể loại</span></a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <span class="col-md-4">
                            ...
                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" id="button-addon1">ADD | <i class="bi bi-plus-circle-fill"></i></button>
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-responsive-md" id="data-table">
                                ...
                                <tr>
                                    ...
                                    <td><strong><?= $cate->getId(); ?></strong></td>
                                    <td><?= $cate->getTentheloai(); ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#EditModal<?= $cate->getId(); ?>"><i class="bi bi-pencil"></i></a>
                                            <a class="btn btn-danger shadow btn-xs sharp delete-btn" data-bs-toggle="modal" data-bs-target="#Modal<?= $cate->getId(); ?>"><i class="bi bi-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="Modal<?= $cate->getId(); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body fs-4">
                                                ...
                                                <span>Bạn có chắc chắn muốn xóa id <?= $cate->getId(); ?> không?</span>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                <a href=".?c=music&a=remove&id=<?= $cate->getId(); ?>" class="btn btn-danger" id="confirmDeleteBtn">Xóa</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="EditModal<?= $cate->getId(); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST">
                                                <div class="modal-body fs-4">
                                                    ...
                                                    <input class="form-control mb-3" name="tenbh" type="text" value="<?= $cate->getTentheloai(); ?>" aria-label="default input example">
                                                </div>
                                                <div class="modal-footer">
