...
<body>
    <div class="">
        <nav class="navbar navbar-expand-lg bg-white" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="author.php"><STRONG>Tác giả</STRONG></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container mt-5">
            <h3 class="text-center"><strong>SỬA THÔNG TIN TÁC GIẢ</strong></h3>
            <?php
            ...
            ?>
            <form action="sql/author/process_edit_author.php" method="POST">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Mã tác giả</span>
                    <input type="text" readonly name="matg" value="<?= $result['ma_tgia'] ?>" class="form-control" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Tên tác giả</span>
                    <input type="text" name="tentg" value="<?= $result['ten_tgia'] ?>" class="form-control" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Hình tác giả</span>
                    <input type="text" name="hinhtg" value="<?= $result['hinh_tgia'] ?>" class="form-control" aria-describedby="basic-addon1">
                </div>
