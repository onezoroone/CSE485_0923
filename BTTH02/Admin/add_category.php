...
<body>
    <div class="">
        ...
        <div class="container mt-5">
            <h3 class="text-center"><strong>THÊM MỚI THỂ LOẠI</strong></h3>
            <form action="sql/category/process_add_categrory.php" method="POST">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Tên thể loại</span>
                    <input type="text" name="tentl" class="form-control" aria-describedby="basic-addon1">
                </div>
